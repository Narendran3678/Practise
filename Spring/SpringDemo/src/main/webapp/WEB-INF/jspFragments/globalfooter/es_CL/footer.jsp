...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/cl/es/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Busca un distribuidor</a> cerca de ti.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/cl/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Política de privacidad</a>
</c:if>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Aviso legal</a>
</c:if>
...
<c:otherwise>https://www.apple.com/cl/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Mapa del sitio</a>
</c:if>
		</div>
	</div>
</section>
