...
<c:otherwise>https://www.apple.com/de/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Datenschutzrichtlinie</a>
</c:if>
...
<c:otherwise>https://www.apple.com/de/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Nutzungsbedingungen</a>
</c:if>
...
<c:otherwise>https://www.apple.com/de/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Verkauf und Rückerstattung</a>
</c:if>
...
<c:otherwise>https://www.apple.com/de/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Rechtliche Hinweise</a>
</c:if>
...
<c:otherwise>https://www.apple.com/de/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Sitemap</a>
</c:if>
		</div>
	</div>
</section>
