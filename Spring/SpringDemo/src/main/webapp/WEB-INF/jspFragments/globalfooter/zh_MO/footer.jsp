...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://www.apple.com/mo/retail/" data-analytics-title="find an apple store">尋找就近的 Apple Store</a> 或<a href="https://locate.apple.com/mo/zh/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>其他零售商</a>。
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/mo/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">私隱政策</a>
</c:if>
...
<c:otherwise>https://www.apple.com/mo/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">使用條款</a>
</c:if>
...
<c:otherwise>https://www.apple.com/mo/legal/</c:otherwise></c:choose>" data-analytics-title="legal">法律聲明</a>
</c:if>
...
<c:otherwise>https://www.apple.com/mo/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">網站地圖</a>
</c:if>
		</div>
	</div>
</section>
