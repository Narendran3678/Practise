...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Copyright © <%= java.time.Year.now()  %> Apple Inc. Todos os direitos reservados.
		</div>
...
<c:otherwise>https://www.apple.com/pt/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Política de Privacidade</a>
</c:if>
...
<c:otherwise>https://www.apple.com/pt/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Termos de Utilização</a>
</c:if>
...
<c:otherwise>https://www.apple.com/pt/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Vendas e reembolsos</a>
</c:if>
...
<c:otherwise>https://www.apple.com/pt/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Avisos legais</a>
</c:if>
...
<c:otherwise>https://www.apple.com/pt/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Mapa do site</a>
</c:if>
		</div>
	</div>
</section>
