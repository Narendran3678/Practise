...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/kz/en/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Find a retailer</a> near you.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/kz/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site Map</a>
</c:if>
		</div>
	</div>
</section>
