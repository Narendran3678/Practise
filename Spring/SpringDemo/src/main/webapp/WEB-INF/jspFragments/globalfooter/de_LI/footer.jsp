...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/li/de/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Finde einen Händler</a> in deiner Nähe.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Nutzungsbedingungen</a>
</c:if>
...
<c:otherwise>https://www.apple.com/li/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Sitemap</a>
</c:if>
		</div>
	</div>
</section>
