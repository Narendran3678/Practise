...
<c:otherwise>https://www.apple.com/za/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Privacy Policy</a>
</c:if>
...
<c:otherwise>https://www.apple.com/za/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Terms of Use</a>
</c:if>
...
<c:otherwise>https://www.apple.com/za/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Legal</a>
</c:if>
...
<c:otherwise>https://www.apple.com/za/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site Map</a>
</c:if>
		</div>
	</div>
</section>
