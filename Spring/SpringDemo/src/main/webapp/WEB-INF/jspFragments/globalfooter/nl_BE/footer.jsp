...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		Andere manieren om te shoppen: <a href="https://www.apple.com/benl/retail/" data-analytics-title="find an apple store">Zoek een Apple Store</a> of <a href="https://locate.apple.com/be/nl/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>andere winkel</a> bij jou in de buurt. <span class="nowrap">Of bel 0800 99846.</span>
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/benl/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Privacybeleid</a>
</c:if>
...
<c:otherwise>https://www.apple.com/benl/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Gebruiksvoorwaarden</a>
</c:if>
...
<c:otherwise>https://www.apple.com/be-nl/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Verkoopvoorwaarden</a>
</c:if>
...
<c:otherwise>https://www.apple.com/benl/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Juridische informatie</a>
</c:if>
...
<c:otherwise>https://www.apple.com/benl/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site-overzicht</a>
</c:if>
		</div>
	</div>
</section>
