...
<c:otherwise>https://www.apple.com/co/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Política de privacidad</a>
</c:if>
...
<c:otherwise>https://www.apple.com/co/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Mapa del sitio</a>
</c:if>
		</div>
	</div>
</section>
