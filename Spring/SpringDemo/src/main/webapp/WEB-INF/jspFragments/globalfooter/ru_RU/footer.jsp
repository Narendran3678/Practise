...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">© Apple Inc., <%= java.time.Year.now()  %> г. Все права защищены.
		</div>
...
<c:otherwise>https://www.apple.com/ru/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Политика конфиденциальности</a>
</c:if>
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/legal/privacy/ru/cookies/" data-analytics-title="use of cookies">Использование cookies</a>
...
<c:otherwise>https://www.apple.com/ru/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Условия использования</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ru/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Продажа и возврат</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ru/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Юридическая информация</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ru/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Карта сайта</a>
</c:if>
		</div>
	</div>
</section>
