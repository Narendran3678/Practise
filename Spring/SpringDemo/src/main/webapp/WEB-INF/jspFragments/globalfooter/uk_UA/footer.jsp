...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/ua/en/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Знайти поруч</a> магазин офіційного партнера.
	</div>
</c:if>
...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">© Apple Inc., <%= java.time.Year.now()  %> р. Усі права захищено.
		</div>
		<div class="ac-gf-footer-legal-links">
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/legal/privacy/uk/" data-analytics-title="privacy policy">Політика конфіденційності</a>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Юридична інформація</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ua/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Карта сайту</a>
</c:if>
		</div>
	</div>
</section>
