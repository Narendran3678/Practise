...
<c:otherwise>https://www.apple.com/uk/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Privacy Policy</a>
</c:if>
...
<c:otherwise>https://www.apple.com/uk/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Terms of Use</a>
</c:if>
...
<c:otherwise>https://www.apple.com/uk/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Sales and Refunds</a>
</c:if>
...
<c:otherwise>https://www.apple.com/uk/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Legal</a>
</c:if>
...
<c:otherwise>https://www.apple.com/uk/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site Map</a>
</c:if>
		</div>
	</div>
</section>
