...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">© „Apple Inc.“, <%= java.time.Year.now()  %>. Visos teisės saugomos.
		</div>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Naudojimo sąlygos</a>
</c:if>
...
<c:otherwise>https://www.apple.com/lt/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Svetainės žemėlapis</a>
</c:if>
		</div>
	</div>
</section>
