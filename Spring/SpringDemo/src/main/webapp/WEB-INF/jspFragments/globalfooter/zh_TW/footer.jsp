...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		更多選購方式：<a href="https://www.apple.com/tw/retail/" data-analytics-title="find an apple store">尋找當地的 Apple 直營店</a>或<a href="https://locate.apple.com/tw/zh/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>其他零售商</a>，<span class="nowrap">或致電 0800-020-021。</span>
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/tw/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">隱私權政策</a>
</c:if>
...
<c:otherwise>https://www.apple.com/tw/legal/internet-services/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">使用條款</a>
</c:if>
...
<c:otherwise>https://www.apple.com/tw/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">銷售及退款</a>
</c:if>
...
<c:otherwise>https://www.apple.com/tw/legal/</c:otherwise></c:choose>" data-analytics-title="legal">法律聲明</a>
</c:if>
...
<c:otherwise>https://www.apple.com/tw/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">網站地圖</a>
</c:if>
		</div>
	</div>
</section>
