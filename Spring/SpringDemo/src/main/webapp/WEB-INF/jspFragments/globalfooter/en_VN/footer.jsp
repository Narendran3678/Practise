...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://www.apple.com/vn/buy/" data-analytics-title="other retailers or resellers">Find a retailer</a> near you.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/vn/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Privacy Policy</a>
</c:if>
...
<c:otherwise>https://www.apple.com/vn/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Legal</a>
</c:if>
...
<c:otherwise>https://www.apple.com/vn/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site Map</a>
</c:if>
		</div>
	</div>
</section>
