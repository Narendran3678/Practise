...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/mg/fr/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Trouvez un revendeur</a>.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/mg/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Plan du site</a>
</c:if>
		</div>
	</div>
</section>
