...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Autortiesības pieder ©  <%= java.time.Year.now()  %> Apple Inc. Visas tiesības aizsargātas.
		</div>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Lietošanas nosacījumi</a>
</c:if>
...
<c:otherwise>https://www.apple.com/lv/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Lapas karte</a>
</c:if>
		</div>
	</div>
</section>
