...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/sk/sk/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Vyhľadaj predajcu</a> v okolí.
	</div>
</c:if>
...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Copyright © <%= java.time.Year.now()  %> Apple Inc. Všetky práva vyhradené.
		</div>
		<div class="ac-gf-footer-legal-links">
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/legal/privacy/sk/cookies/" data-analytics-title="use of cookies">Použitie cookies</a>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Podmienky používania</a>
</c:if>
...
<c:otherwise>https://www.apple.com/sk/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Mapa stránky</a>
</c:if>
		</div>
	</div>
</section>
