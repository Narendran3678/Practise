...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/sa/en/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>اعثر على بائع تجزئة</a> بالقرب منك.
	</div>
</c:if>
...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">العلامة التجارية وجميع الحقوق محفوظة. © <%= java.time.Year.now()  %> ‏.Apple Inc
		</div>
...
<c:otherwise>https://www.apple.com/sa-ar/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">سياسة الخصوصية</a>
</c:if>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="legal">المعلومات القانونية</a>
</c:if>
...
<c:otherwise>https://www.apple.com/sa-ar/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">خريطة الموقع</a>
</c:if>
		</div>
	</div>
</section>
