...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Autoriõigus © <%= java.time.Year.now()  %>, Apple Inc. Kõik õigused kaitstud.
		</div>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Kasutustingimused</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ee/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Saidikaart</a>
</c:if>
		</div>
	</div>
</section>
