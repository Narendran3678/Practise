...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">© <%= java.time.Year.now()  %> Apple Inc. Всички права запазени.
		</div>
		<div class="ac-gf-footer-legal-links">
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/legal/privacy/bg/cookies/" data-analytics-title="use of cookies">Използване на кукита</a>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Условия за употреба</a>
</c:if>
...
<c:otherwise>https://www.apple.com/bg/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Карта на сайта</a>
</c:if>
		</div>
	</div>
</section>
