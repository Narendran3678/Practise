...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<p>طرق أخرى للشراء: <a href="https://www.apple.com/ae/retail/" data-analytics-title="find an apple store">اعثر على متجر Apple Store‏</a> أو
			<a href="https://locate.apple.com/ae/en/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>بائع تجزئة</a> بالقرب منك، <span class="nowrap">أو اتصل على 0396 444 8000.</span>
		</p>
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/ae-ar/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">سياسة الخصوصية</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ae/legal/</c:otherwise></c:choose>" data-analytics-title="legal">المعلومات القانونية</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ae-ar/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">خريطة الموقع</a>
</c:if>
		</div>
	</div>
</section>
