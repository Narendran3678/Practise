...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Copyright © <%= java.time.Year.now()  %> Apple Inc. Alle Rechte vorbehalten.
		</div>
...
<c:otherwise>https://www.apple.com/chde/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Datenschutzrichtlinie</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chde/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Nutzungsbedingungen</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ch-de/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Verkauf und Rückerstattung</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chde/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Rechtliche Hinweise</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chde/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Sitemap</a>
</c:if>
		</div>
	</div>
</section>
