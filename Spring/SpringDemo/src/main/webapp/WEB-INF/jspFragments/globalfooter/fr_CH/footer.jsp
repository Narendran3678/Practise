...
<c:otherwise>https://www.apple.com/chfr/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Engagement de confidentialité</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chfr/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Conditions d’utilisation</a>
</c:if>
...
<c:otherwise>https://www.apple.com/ch-fr/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Ventes et remboursements</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chfr/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Mentions légales</a>
</c:if>
...
<c:otherwise>https://www.apple.com/chfr/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Plan du site</a>
</c:if>
		</div>
	</div>
</section>
