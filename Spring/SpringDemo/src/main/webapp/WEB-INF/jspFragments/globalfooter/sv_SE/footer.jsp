...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Copyright © <%= java.time.Year.now()  %> Apple Inc. Alla rättigheter förbehålls.
		</div>
...
<c:otherwise>https://www.apple.com/se/legal/privacy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Integritetspolicy</a>
</c:if>
...
<c:otherwise>https://www.apple.com/se/legal/terms/site.html</c:otherwise></c:choose>" data-analytics-title="terms of use">Användningsvillkor</a>
</c:if>
...
<c:otherwise>https://www.apple.com/se/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Försäljning och återbetalning</a>
</c:if>
...
<c:otherwise>https://www.apple.com/se/legal/</c:otherwise></c:choose>" data-analytics-title="legal">Juridisk information</a>
</c:if>
...
<c:otherwise>https://www.apple.com/se/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Sajtkarta</a>
</c:if>
		</div>
	</div>
</section>
