...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Copyright © <%= java.time.Year.now()  %> Apple Inc. Minden jog fenntartva.
		</div>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Használati feltételek</a>
</c:if>
...
<c:otherwise>https://www.apple.com/hu/shop/goto/help/sales_refunds</c:otherwise></c:choose>" data-analytics-title="sales and refunds">Értékesítés és visszatérítés</a>
</c:if>
...
<c:otherwise>https://www.apple.com/hu/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Webhelytérkép</a>
</c:if>
		</div>
	</div>
</section>
