...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/hr/hr/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Pronađi najbližu trgovinu.</a>
	</div>
</c:if>
...
<div class="ac-gf-footer-locale"><c:import url="/WEB-INF/jspFragments/flag.jsp" charEncoding="UTF-8"/></div>
	...
	<div class="ac-gf-footer-legal">
		<div class="ac-gf-footer-legal-copyright">Autorsko pravo © <%= java.time.Year.now()  %>. Apple Inc. Sva prava pridržana.
		</div>
		<div class="ac-gf-footer-legal-links">
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/legal/privacy/hr/cookies/" data-analytics-title="use of cookies">Upotreba kolačića</a>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Uvjeti korištenja</a>
</c:if>
...
<c:otherwise>https://www.apple.com/hr/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Mapa web-mjesta</a>
</c:if>
		</div>
	</div>
</section>
