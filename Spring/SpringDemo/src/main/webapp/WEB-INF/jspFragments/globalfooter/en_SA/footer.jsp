...
<div class="ac-gf-footer-shop" x-ms-format-detection="none">
		<a href="https://locate.apple.com/sa/en/" data-analytics-title="other retailers or resellers" data-analytics-exit-link>Find a retailer</a> near you.
	</div>
</c:if>
...
<c:otherwise>https://www.apple.com/sa/privacy/privacy-policy/</c:otherwise></c:choose>" data-analytics-title="privacy policy">Privacy Policy</a>
</c:if>
...
<c:otherwise>https://www.apple.com/legal/</c:otherwise></c:choose>" data-analytics-title="terms of use">Terms of Use</a>
			...
			<a class="ac-gf-footer-legal-link" href="https://www.apple.com/sa/legal/" data-analytics-title="legal">Legal</a>
...
<c:otherwise>https://www.apple.com/sa/sitemap/</c:otherwise></c:choose>" data-analytics-title="site map">Site Map</a>
</c:if>
		</div>
	</div>
</section>
