...
{
	private static void ArraySequentialDemo() {
		...
		//strings.add("a");
		strings.set(0, "john");
		System.out.println("Updated.."+Arrays.toString(strArray));
	...
	public static void ArrayParallelizedDemo()
	{
		int[] arr = {10,3,15,78,24};
		IntBinaryOperatorImpl binaryImpl= new IntBinaryOperatorImpl();
		Arrays.parallelPrefix(arr,binaryImpl);
		System.out.println(Arrays.toString(arr));
		
		IntUnaryOperatorImpl unaryImpl= new IntUnaryOperatorImpl();
		unaryImpl.setArray(arr);
		Arrays.parallelSetAll(arr, unaryImpl);
		System.out.println(Arrays.toString(arr));
	}
	public static void main(String[] args) {
		ArraysDemo.ArrayParallelizedDemo();
	}
}
