...
private Deque<Weblink> queue = new ArrayDeque<>();
		...
		public void run() {
			...
			try {
				//synchronized (weblink) {					
					InputStream in = IOUtils.httpConnect(weblink.getUrl());
	...
	public static void main(String[] args) {
		...
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2000, "Wikipedia", "https://en.wikipedia.org/wiki/Google", "https://en.wikipedia.org/wiki/Google"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2001, "Tomcat","https://tomcat.apache.org/", "https://tomcat.apache.org/"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2002, "StackOverflow", "https://stackoverflow.com/", "https://stackoverflow.com/"));
